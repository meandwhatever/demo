...
import { ArrowLeft, Mail, ExternalLink, User, Settings, ChevronDown, ChevronUp, History } from 'lucide-react';
...
const DocumentReview = () => {
  ...
  const documentType = searchParams.get('type') || 'Unknown';
  
  const getDocumentMetadata = (type: string) => {
    const baseMetadata = {
      date: '2024-03-15',
      fromEmail: 'supplier@abcmanufacturing.com',
      emailSubject: 'Re: Shipment Documentation - Order #12345'
    };
    ...
    switch (type) {
      case 'MBL':
        return {
          ...baseMetadata,
          emailSubject: 'Master Bill of Lading - Shipment #MBL-12345'
        };
      case 'Commercial Invoice':
        return {
          ...baseMetadata,
          emailSubject: 'Commercial Invoice - Order #67890'
        };
      case 'HBL':
        return {
          ...baseMetadata,
          emailSubject: 'House Bill of Lading - Shipment #HBL-54321'
        };
      case 'Pack List':
        return {
          ...baseMetadata,
          emailSubject: 'Packing List - Order #98765'
        };
      default:
        return baseMetadata;
    }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <Button 
              variant="ghost" 
              size="sm"
              onClick={() => navigate('/document-review-list')}
      ...
      <div className="flex h-[calc(100vh-120px)]">
        ...
        <div className="w-1/2 bg-white flex flex-col">
          <div className={`${isAIVisible ? 'flex-[3]' : 'flex-1'} border-b border-slate-200 overflow-hidden`}>
            <DocumentFields documentType={documentType} />
          </div>
