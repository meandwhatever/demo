...
export default function AiChatCard() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl h-full rounded-2xl border-2 bg-white p-4 shadow-lg shadow-gray-300 bg-blue-500">
      {/* Card header */}
      ...
      <div className="flex-1 h-96 overflow-y-auto pr-2 bg-red-500">
        {showHistory ? (
          <div className="pb-4">
            {/* History header row */}
      ...
      {/* Chat box */}
      <div className="rounded-xl p-2 bg-white mt-4 ">
        ...
        {/* Text box + actions */}
        <div className="rounded-xl border p-1.5 bg-white h-full shadow-md">
