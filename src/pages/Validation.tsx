...
const Validation = () => {
  ...
  const getDocumentMetadata = (type: string) => {
    const baseMetadata = {
      ...
      emailSubject: type === 'MBL' ? 'Master Bill of Lading - Shipment #MBL-12345' : 'House Bill of Lading - Shipment #HBL-54321'
    };
    return baseMetadata;
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <Button 
              variant="ghost" 
              size="sm"
              onClick={() => navigate('/validation-list')}
      ...
      <div className="flex h-[calc(100vh-120px)]">
        ...
        {/* Right Panel - Validation Fields and AI Chat */}
