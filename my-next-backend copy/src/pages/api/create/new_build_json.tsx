...
export function combineMBLAndHBLToShipment(
    ...
    const shipment_json = {
        ...
        "created_by": "user",
        "involved_party": {
            "shipper_name": hbl_json.shipper.name,
            "shipper_address": hbl_json.shipper.address,
            "consignee_name": hbl_json.consignee.name,
            "consignee_address": hbl_json.consignee.address,
            "orgin_agent_name": mbl_json.shipper.name,
            "orgin_agent_address": mbl_json.shipper.address,
            "destination_agent_name": hbl_json.consignee.name,
            "destination_agent_address": hbl_json.consignee.address,
        },
        "shipment": {
            "master_bill_of_lading_number": mbl_json.shipment.mbl_number,
            "house_bill_of_lading_number": hbl_json.shipment.hbl_number,
            "vessel_name": mbl_json.shipment.vessel_name,
            "voyage_number": mbl_json.shipment.voyage_number,
            "port_of_loading": mbl_json.shipment.port_of_loading,
            "port_of_discharge": mbl_json.shipment.port_of_discharge,
            "place_of_receipt": mbl_json.shipment.place_of_receipt,
            "place_of_delivery": mbl_json.shipment.place_of_delivery,
            "freight_mode": mbl_json.shipment.mode,
            "total_number_of_containers": mbl_json.shipment.total_number_of_containers,
            "total_weight": mbl_json.shipment.total_weight,
            "total_volume": mbl_json.shipment.total_volume,
            "total_package": mbl_json.shipment.total_package,
        },

        "containers": mbl_json.containers,
        "freight_charges": mbl_json.freight_charges,
    }
